  ...
  return (
    <div className="pt-[5rem] pb-[3rem] bg-gray-900">
      <div className="w-[80%] pb-[2rem] border-b-[2px] border-b-gray-300 border-opacity-50 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[3rem] items-start">
        ...
        <div>
          ...
          <p className="text-white text-opacity-60 mt-[0.4rem]">
            Welcome to BurgerBite, where we serve the juiciest and most
            delicious burgers in town. Experience the taste of perfection with
            every bite, crafted with love and care.
          </p>
        ...
        <div>
          ...
          <p
            className="mt-[0.7rem] text-white opacity-60 hover:text-yellow-300
      ...
      <p className="text-center text-white opacity-50 mt-[1.5rem]">
        Copyright © 2024 <span>Mary Okunola</span> All rights reserved
      </p>
    </div>
  );
};
