  ...
  return (
    <div className="h-[12vh] bg-white">
      <div className="sm:w-[90%] w-[95%] mx-auto flex h-[100%] items-center justify-between">
        ...
        {/* Nav Links */}
        <ul className="hidden lg:flex items-center font-semibold space-x-10">
          <li className="text-[20px]  hover:text-red-600">
            <Link href="/">Home</Link>
          </li>
          <li className="text-[20px]  hover:text-red-600">
            <Link href="/">Shop</Link>
        ...
        <div className="flex items-center space-x-4">
          <button className="px-6 sm:px-8 py-2 sm:py-3 text-[14px] sm:text-[16px] bg-blue-950 transition-all duration-200 hover:bg-red-500 flex items-center rounded-md space-x-2 text-white">
            <span>
