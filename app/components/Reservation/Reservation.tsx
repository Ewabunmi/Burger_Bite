      ...
      <div className="w-[80%] relative z-[20%] mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-[3rem]">
        ...
        <div>
          ...
          <p className="text-[17px] mt-[1rem] text-white text-opacity-50">
            Make your evening special with our exquisite dining experience.
            Whether it&apos;s a family gathering or a romantic dinner, we ensure
            a memorable time with our delectable menu and cozy ambiance. Book
            your table now to enjoy the best seats in the house.
          </p>
