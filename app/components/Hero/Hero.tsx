...
import burgerImg2 from "../../../public/images/b1.png";
        ...
        <div className="w-[80%] grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-[2rem] mx-auto ">
          ...
          <div>
            ...
            <p className="mt-[1rem] text-white">
              Indulge in the ultimate burger experience! Our fast food burgers
              are crafted to perfection, delivering unbeatable taste with every
              bite. Join us for a feast that will leave your taste buds craving
              more.
            </p>
